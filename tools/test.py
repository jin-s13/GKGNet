...
def parse_args():
    ...
    parser.add_argument('--ne',type=int,default=5, help='output result file')
    ...
    parser.add_argument('--outtxt', default='result.txt', help='store results')
    parser.add_argument(
